package kb_virsorter::kb_virsorterClient;
...
kb_virsorter::kb_virsorterClient
...
sub new
{
    ...
    my $self = {
	client => kb_virsorter::kb_virsorterClient::RpcClient->new,
	url => $url,
	headers => [],
    };
...
sub _validate_version {
    ...
    if ($sMinor > $cMinor) {
        warn "New client version available for kb_virsorter::kb_virsorterClient\n";
    }
    if ($sMajor == 0) {
        warn "kb_virsorter::kb_virsorterClient version is $svr_version. API subject to change.\n";
    }
}
...
package kb_virsorter::kb_virsorterClient::RpcClient;
